...
const TourGallery = ({ images, title, maxThumbnails = 4 }: TourGalleryProps) => {
  ...
  return (
    <>
      {/* Gallery Grid */}
      <div className="grid grid-cols-4 grid-rows-2 gap-1.5 rounded-xl overflow-hidden h-[320px] md:h-[400px]">
        {/* Hero image */}
        <div
          className="col-span-4 md:col-span-3 row-span-2 relative cursor-pointer group"
        ...
        <div className="hidden md:flex col-span-1 row-span-2 flex-col gap-1.5">
        ...
        {images.length > 1 && (
          <button
            onClick={() => openLightbox(0)}
            className="md:hidden absolute bottom-3 right-3 bg-background/90 backdrop-blur-sm text-foreground text-xs font-medium px-3 py-1.5 rounded-full shadow-md flex items-center gap-1.5 z-10"
          >
          ...
          {images.length > 1 && (
            <>
              <Button
                variant="ghost"
                size="icon"
                className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white hover:bg-white/10 h-10 w-10 md:h-12 md:w-12 rounded-full z-20"
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white hover:bg-white/10 h-10 w-10 md:h-12 md:w-12 rounded-full z-20"
                onClick={() => navigateLightbox(1)}
              >
